...
import FlatProperties from '../generated/flatmd/components/time-domain-electromagnetic-channel-1.0.1.md';

# time-domain-electromagnetic-channel

<SchemaUri uri="schema/components/time-domain-electromagnetic-channel/1.0.1/time-domain-electromagnetic-channel.schema.json" />
