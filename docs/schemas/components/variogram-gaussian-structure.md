...
A Gaussian variogram model structure, used as a component of the [variogram](../variogram.md) object.
The Gaussian model is characterised by a parabolic behaviour near the origin, producing very smooth fields.
