...
import FlatProperties from '../generated/flatmd/components/block-model-category-attribute-1.0.0.md';

# block-model-category-attribute

<SchemaUri uri="schema/components/block-model-category-attribute/1.0.0/block-model-category-attribute.schema.json" />
