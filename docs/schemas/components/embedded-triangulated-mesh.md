...
**Used by:** [triangle-mesh](../objects/triangle-mesh.md), [geological-model-meshes](../objects/geological-model-meshes.md), [volumetric-model-meshes](../objects/volumetric-model-meshes.md).
