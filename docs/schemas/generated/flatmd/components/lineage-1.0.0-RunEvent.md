...
| run | [lineage](../components/lineage-1.0.0-RunEvent-Run.md) |  |  |
| job | [lineage](../components/lineage-1.0.0-RunEvent-Job.md) |  |  |
| inputs | Array[[lineage](../components/lineage-1.0.0-RunEvent-InputDataset.md)] | The set of **input** datasets. |  |
| outputs | Array[[lineage](../components/lineage-1.0.0-RunEvent-OutputDataset.md)] | The set of **output** datasets. |  |
