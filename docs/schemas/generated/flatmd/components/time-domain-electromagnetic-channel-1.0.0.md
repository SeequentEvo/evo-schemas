...
| inclinometers_transmitter_position | Array[[coordinates-3d](../elements/coordinates-3d-1.0.0.md)] | Inclinometers transmitter position. |  |
| inclinometers_receiver_position | Array[[coordinates-3d](../elements/coordinates-3d-1.0.0.md)] | Inclinometers receiver position. |  |
...
| front_gate_filter | [time-domain-electromagnetic-channel](../components/time-domain-electromagnetic-channel-1.0.0-filter.md) | Front gate filter. |  |
| front_gate_time | Number | Front gate time (sec). |  |
| front_gate_slope_low_pass_filter | [time-domain-electromagnetic-channel](../components/time-domain-electromagnetic-channel-1.0.0-filter.md) | Slope low pass filter before front gate. |  |
