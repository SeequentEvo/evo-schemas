### survey-attribute-definition (v1.0.2)
...
| offset | [coordinates-3d](../elements/coordinates-3d-1.0.1.md) | Offset of attribute measurements relative to the point of reference. |  |
