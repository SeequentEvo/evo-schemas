...
|---|---|---|---|
| vertices | [triangles](../components/triangles-1.1.0-vertices.md) | Vertex coordinates. Columns: x, y, z. | [⬆️](../components/triangles-1.1.0.md) |
| indices | [triangles](../components/triangles-1.1.0-indices.md) | 0-based indices into the vertices. Each triple is a triangle. Columns: n0, n1, n2. | [⬆️](../components/triangles-1.1.0.md) |
