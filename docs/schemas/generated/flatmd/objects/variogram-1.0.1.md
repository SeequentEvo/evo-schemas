...
| structures | Array[[variogram](../objects/variogram-1.0.1-structures.md)] | A list of at least one mathematical model, which are parameterised to represent the spatial structure of the variogram model. |  |
