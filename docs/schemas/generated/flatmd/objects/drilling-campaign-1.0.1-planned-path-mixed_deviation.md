...
| segment_properties | [drilling-campaign](../objects/drilling-campaign-1.0.1-planned-path-mixed_deviation-segment_properties.md) | The path taken by the planned drillhole using both natural and directed deviations. Columns: distance, azimuth, dip, lift rate, drift rate, deviation rate distance, toolface angle, dogleg severity | ✅ |
