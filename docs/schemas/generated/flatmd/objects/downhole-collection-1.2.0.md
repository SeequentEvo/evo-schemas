...
| location | [downhole-collection](../objects/downhole-collection-1.2.0-location.md) | The locations of the downholes in the collection. | ✅ |
| collections | Array[[downhole-collection](../objects/downhole-collection-1.2.0-collections.md)] | The collections of data associated with the downhole collection. | ✅ |
