...
| ellipsoid_ranges | [ellipsoid](../components/ellipsoid-1.1.0-ellipsoid_ranges.md) | An ellipsoid as defined by three lengths, for the major, semi-major and minor axes rotated in space as defined by the rotation. | [⬆️](../components/ellipsoid-1.1.0.md) ✅ |
| rotation | [rotation](../components/rotation-1.1.0.md) | Rotation of the ellipsoid | [⬆️](../components/ellipsoid-1.1.0.md) ✅ |
| schema | String |  | ✅ |
