...
| schema | String |  | ✅ |
| cdf | [cumulative-distribution-function](../components/cumulative-distribution-function-1.0.1.md) | Cumulative distribution function. | ✅ |
| is_declustered | Boolean | Is declustered. | ✅ |
| support | [non-parametric-continuous-cumulative-distribution](../objects/non-parametric-continuous-cumulative-distribution-1.2.1-support.md) | Support options. | ✅ |
