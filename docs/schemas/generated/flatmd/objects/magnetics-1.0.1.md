...
| gradient_magnetic | [magnetics](../objects/magnetics-1.0.1-gradient_magnetic.md) | Gradient magnetic details. |  |
| base_stations | Array[[magnetics](../objects/magnetics-1.0.1-base_stations.md)] | Base stations. |  |
| magnetic_line_list | Array[[survey-line](../components/survey-line-1.0.1.md)] | Magnetic line list. |  |
| qaqc_magnetic_azimuth_test_list | Array[[survey-line](../components/survey-line-1.0.1.md)] | QA/QC Magnetic azimuth test list. |  |
| qaqc_noise_test_list | Array[[survey-line](../components/survey-line-1.0.1.md)] | QA/QC Magnetic noise test list. |  |
