...
| geometry | [block-model](../objects/block-model-1.0.1-geometry.md) | The geometry (including subblocking parameters, if applicable) of the block model. | ✅ |
| attributes | Array[[block-model](../objects/block-model-1.0.1-attributes.md)] | The attributes found on this version of the block model. |  |
