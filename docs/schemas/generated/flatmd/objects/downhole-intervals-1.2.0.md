...
| start | [locations](../components/locations-1.0.1.md) | Start locations. | ✅ |
| end | [locations](../components/locations-1.0.1.md) | End locations. | ✅ |
| mid_points | [locations](../components/locations-1.0.1.md) | Mid-point locations. | ✅ |
