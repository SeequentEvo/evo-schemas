...
| boundary_surfaces | Array[Integer] | Indices into 'surfaces' of the surfaces that lie on the boundary of the model extent. A derived index: if present it must list every surface that specifies 'boundary_face' and no others. |  |
