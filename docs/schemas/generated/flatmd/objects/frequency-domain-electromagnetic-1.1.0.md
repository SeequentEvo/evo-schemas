...
| schema | String |  | ✅ |
| survey | [frequency-domain-electromagnetic](../objects/frequency-domain-electromagnetic-1.1.0-survey.md) | Survey information. | ✅ |
| data_type | String | Data type. |  |
| channels | Array[[frequency-domain-electromagnetic-channel](../components/frequency-domain-electromagnetic-channel-1.0.0.md)] | Channel information. | ✅ |
