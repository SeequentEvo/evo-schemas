...
| gradient_magnetic | [magnetics](../objects/magnetics-2.0.0-gradient_magnetic.md) | Gradient magnetic details. |  |
| base_stations | Array[[magnetics](../objects/magnetics-2.0.0-base_stations.md)] | Base stations. |  |
...
| collections | Array[[survey-collection](../components/survey-collection-1.0.1.md)] | Magnetic survey collections. | ✅ |
| qaqc_magnetic_azimuth_test_list | Array[[survey-collection](../components/survey-collection-1.0.1.md)] | QA/QC Magnetic azimuth test list. |  |
| qaqc_noise_test_list | Array[[survey-collection](../components/survey-collection-1.0.1.md)] | QA/QC Magnetic noise test list. |  |
