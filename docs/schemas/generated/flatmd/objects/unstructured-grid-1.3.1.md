...
| schema | String |  | ✅ |
| geometry | [unstructured-grid-geometry](../components/unstructured-grid-geometry-1.2.1.md) | The geometry information of the unstructured grid. | ✅ |
