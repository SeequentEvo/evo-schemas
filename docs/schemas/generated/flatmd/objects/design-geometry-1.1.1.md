...
| vertices_2d | [vertices-2d](../components/vertices-2d-1.0.2.md) | Vertex coordinates in 2D space. |  |
| vertices_3d | [vertices-3d](../components/vertices-3d-1.0.2.md) | Vertex coordinates in 3D space. |  |
...
| parts | Array[[geometry-part](../components/geometry-part-1.0.2.md)] | List of geometry parts. | ✅ |
