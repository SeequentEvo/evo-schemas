...
| grid_cells_2d | [tensor-2d-grid](../objects/tensor-2d-grid-1.1.0-grid_cells_2d.md) | Grid cell sizes along the axes |  |
| rotation | [rotation](../components/rotation-1.0.1.md) | Orientation of the grid. |  |
| cell_attributes | [one-of-attribute](../components/one-of-attribute-1.1.0.md) | Attributes associated with the cells. |  |
| vertex_attributes | [one-of-attribute](../components/one-of-attribute-1.1.0.md) | Attributes associated with the vertices. |  |
