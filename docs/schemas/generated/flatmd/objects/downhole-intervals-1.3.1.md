...
| start | [locations](../components/locations-1.0.2.md) | Start locations. | ✅ |
| end | [locations](../components/locations-1.0.2.md) | End locations. | ✅ |
| mid_points | [locations](../components/locations-1.0.2.md) | Mid-point locations. | ✅ |
| from_to | [from-to](../components/from-to-1.0.1.md) | From-to description. | ✅ |
