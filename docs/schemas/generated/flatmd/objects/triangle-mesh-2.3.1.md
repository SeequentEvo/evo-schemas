...
| triangles | [triangles](../components/triangles-1.2.1.md) | The vertices and triangle indices of the mesh. | [⬆️](../components/embedded-triangulated-mesh-2.1.1.md) ✅ |
| parts | [embedded-triangulated-mesh](../components/embedded-triangulated-mesh-2.1.1-parts.md) | A structure defining triangle chunks the mesh is composed of. | [⬆️](../components/embedded-triangulated-mesh-2.1.1.md) |
| schema | String |  | ✅ |
| edges | [triangle-mesh](../objects/triangle-mesh-2.3.1-edges.md) | An optional structure defining edges and edge chunks of the mesh. |  |
