...
| schema | String |  | ✅ |
| segments | [segments](../components/segments-1.2.0.md) | Vertices and segments. | ✅ |
| parts | [line-segments](../objects/line-segments-2.2.0-parts.md) | An optional structure defining segment chunks the line collection is composed of. |  |
