### lineations-data-pointset (v1.3.1)
...
| schema | String |  | ✅ |
| locations | [lineations-data-pointset](../objects/lineations-data-pointset-1.3.1-locations.md) | The structural lineations data and attributes. | ✅ |
