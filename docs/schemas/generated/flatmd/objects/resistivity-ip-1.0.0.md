...
| survey | [resistivity-ip](../objects/resistivity-ip-1.0.0-survey.md) | Survey information. | ✅ |
| configuration | [resistivity-ip](../objects/resistivity-ip-1.0.0-configuration.md) | Configuration information. | ✅ |
