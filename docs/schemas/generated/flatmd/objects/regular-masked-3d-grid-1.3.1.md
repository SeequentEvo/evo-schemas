...
| schema | String |  | ✅ |
| origin | Array[Number] | The coordinates of the grid origin, expressed on the axes of the object's coordinate_reference_system in order [x, y, z] | ✅ |
...
| mask | [bool-attribute](../components/bool-attribute-1.1.0.md) | Attribute that indicates which cells have values. | ✅ |
