### time-domain-electromagnetic (v1.1.1)
...
| schema | String |  | ✅ |
| survey | [time-domain-electromagnetic](../objects/time-domain-electromagnetic-1.1.1-survey.md) | Survey information. | ✅ |
| geometry_category | String | Geometry category. | ✅ |
| gps | [coordinates-3d](../elements/coordinates-3d-1.0.1.md) | Location of GPS relative to point of reference. | ✅ |
| channels | Array[[time-domain-electromagnetic-channel](../components/time-domain-electromagnetic-channel-1.0.1.md)] | Channel information. | ✅ |
