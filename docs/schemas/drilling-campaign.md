...
| segment_type | A list to indicate which settings should be used for each segment either deviation rate distance, lift rate and drift rate for 'natural' or tool face angle and dogleg severity for 'mixed'|
