...
2D array of 64-bit floating-point values (width = 2). Extends [float-array-md](float-array-md.md) with a fixed width of 2. Used for paired values such as 2D coordinates and from-to depth ranges.
